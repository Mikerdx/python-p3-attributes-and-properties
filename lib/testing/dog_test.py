...
class TestDog:
    ...
    def test_is_class(self):
        ...
        fido = Dog(name="Fido")  # Provide name when creating Dog instance
    ...
    def test_name_not_empty(self):
        ...
        Dog(name="")  # Provide name when creating Dog instance
    ...
    def test_name_string(self):
        ...
        captured_out = io.StringIO()
        sys.stdout = captured_out
        Dog(name=123)  # Provide name when creating Dog instance
        sys.stdout = sys.__stdout__
        assert(captured_out.getvalue() == "Name must be string between 1 and 25 characters.\n")
    ...
    def test_name_under_25(self):
        ...
        captured_out = io.StringIO()
        sys.stdout = captured_out
        Dog(name="What do dogs do on their day off? Can't lie around - that's their job.")  # Provide name
        sys.stdout = sys.__stdout__
        assert(captured_out.getvalue() == "Name must be string between 1 and 25 characters.\n")
    ...
    def test_breed_not_in_list(self):
        ...
        captured_out = io.StringIO()
        sys.stdout = captured_out
        Dog(name="Fido", breed="Human")  # Provide name and breed when creating Dog instance
        sys.stdout = sys.__stdout__
    ...
    def test_breed_in_list(self):
        ...
        fido = Dog(name="Fido", breed="Pug")  # Provide name and breed when creating Dog instance
